...
##/usr/local/bin/python3.12 /Users/c29369/Downloads/shopping/shopping.py /Users/c29369/Downloads/shopping/shopping.csv
        ...
        for row in reader:
            try:
                evidence.append([
                    ...
                    int(row[15] == "Returning_Visitor"), int(bool(row[16]))
                ])
                labels.append(int(row[17] == 'TRUE'))
            except ValueError as e:
                print(f"Row {reader.line_num} could not be processed: {e}")
